...
class ContentDateTest {
    ...
    void contentDate는_now보다_미래일수_없다(LocalDate contentDate, LocalDate now, LocalDate birthday) {
    ...
    void contentDate는_birthday의_2년전까지_유효하다(LocalDate contentDate, LocalDate now, LocalDate birthday) {
        assertThatThrownBy(() -> ContentDate.of(contentDate, now, birthday))
                .isInstanceOf(ContentDateBadRequestException.class);
    }
    ...
    void contentDate는_now보다_과거이고_birthday의_2년이내이다(LocalDate contentDate, LocalDate now, LocalDate birthday) {
